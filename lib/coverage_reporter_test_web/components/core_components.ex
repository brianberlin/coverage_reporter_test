defmodule CoverageReporterTestWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CoverageReporterTestWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CoverageReporterTestWeb.Gettext, "errors", msg, opts)
    end
  end
